...
export function TestimonialCard({ testimonial }: TestimonialCardProps) {
  return (
    <div className="bg-brand-white/[0.02] backdrop-blur-xl p-5 md:p-8 lg:p-10 rounded-2xl flex flex-col justify-between border border-white/[0.06] gap-6 md:gap-8 hover:border-white/[0.1] hover:bg-brand-white/[0.04] hover:-translate-y-1 transition-all duration-300 group">
