    ...
    >
      ...
      <div className="flex flex-col flex-grow">
        <div className="flex items-center gap-3 mb-3">
          <span className="text-[10px] uppercase font-bold tracking-[0.15em] text-brand-white bg-brand-white/[0.05] backdrop-blur-md px-3 py-1.5 rounded-full border border-white/[0.06]">
            {post.tag}
          </span>
          <span className="text-[11px] text-brand-muted backdrop-blur-sm">{post.readTime}</span>
        </div>
