...
export function BlogCard({ post }: BlogCardProps) {
  return (
    <a href={`/blog/${post.slug}`} className="group flex flex-col gap-5">
      <article className="cursor-pointer flex flex-col gap-5">
        ...
        <div className="flex flex-col flex-grow">
          ...
          <div className="flex items-center gap-2 mt-5 text-sm font-bold text-brand-white transition-all duration-300 group-hover:gap-3">
            Ler artigo
